            ...
            <Layout style={{backgroundColor: "white"}}>
                ...
                <Content textAlign="center">
                    <Row justify="center" gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                        <Col className="gutter-row"><RecordList records={records.slice(0, 5)} maxWidth={250} isWishlist={false} column={5} /></Col>
                    </Row>
                    <Row justify="center" gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                        <Col className="gutter-row"><RecordList records={records.slice(5, 10)} maxWidth={250} isWishlist={false} column={5} /></Col>
                    </Row>
