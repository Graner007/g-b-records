...
export default class Navbar extends Component {
    render() {
        return (
            <Menu theme="light" mode="horizontal" style={{fontSize: 17}}>
                ...
                <Menu.Item key="5" style={{marginLeft: "auto"}}><Link to="/cart"><ShoppingCartOutlined style={{fontSize: 22}} /></Link></Menu.Item>
                <Menu.Item key="6">
